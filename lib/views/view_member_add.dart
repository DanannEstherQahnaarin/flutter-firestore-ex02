          ...
          child: ListBody(
            children: [
              ...
              DropdownMenu(
                ...
                dropdownMenuEntries: UserRole.values.map<DropdownMenuEntry<UserRole>>((
                  UserRole option,
                ) {
...
void _addMember({
  ...
  if (user != null) {
    ...
    final String result = await addMemberToFirebase(
      name: name,
      uid: user.uid,
      email: email,
      userRole: role,
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          result == Answer.success.name ? 'Member added successfully' : 'Failed to add member',
        ),
      ),
    );
