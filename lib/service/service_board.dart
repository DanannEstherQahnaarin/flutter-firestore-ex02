...
class BoardService {
  void submitBoard({required Member member, required String title, required String content}) async {
    final newBoard = Board(title: title, content: content, writerUid: member.uid, writerNm: member.name, timestamp: DateTime.now());
